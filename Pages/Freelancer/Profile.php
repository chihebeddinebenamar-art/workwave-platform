...
<html>
    ...
    <body>
         ...
         function error($msg) {
          ...
          function successfully($msg) {
            ...
            { 
             ...
             $txt=" <br><br> <h5> You have been accepted </h5>  into nameS project nameP <br><br><br><h5> You have been accepted </h5>  into nameS project nameP <br><br><br>";

            echo "
            <script>
            Swal.fire({
     
             html:`<div class='avatar'> $txt</div>  `,
             width:400,
             ...
             confirmButtonColor: '#DD6B55',
              ...
              if (result.isConfirmed) {
                  location.href='http://localhost:8000/Pages/Freelancer/Profile.php?id=$id';
              } else {
                  location.href='http://localhost:8000/Pages/Freelancer/Profile.php?id=$id';
              }
            }
       ...
       <div id="contact" class="contact-us section">
         ...
         <div class="row">
         <div class="main-red-button-dec" id="deconnecter" ><a href="../../Login.php"> 
         <i class="fa fa-sign-out" ></i> Se déconnecter </a>
           ...
           <form id="contact" action="" method="post">
            ...
            <br>
             ...
             <form id="contact" action="" method="post">
             <a class="logo">
              <h4>Your<span> Information</span></h4>
             </a>
             <br>
             <div class="row">
             <div class="col-lg-6">
               <fieldset>
                 <input type="text" name="name" id="name" placeholder="Full name" autocomplete="off" value='.$name.'>
               </fieldset>
             </div>
             <div class="col-lg-6">
               <fieldset>
                 <input type="text" name="phone" id="phone" placeholder="Your Phone" autocomplete="off" value='.$phone.'>
               </fieldset>
             </div>
             <div class="col-lg-12">
               <fieldset>
               <input type="email" name="email" id="email" placeholder="Your Email" autocomplete="off" value='.$email.'>
               </fieldset>
             </div>
             ...
             <div class="col-lg-12">
               <fieldset>
                 <textarea name="info" type="text" class="form-control" id="info" placeholder="Your info" >'.$info.'</textarea>  
               </fieldset>
             </div>
              ...
              <div class="col-lg-12">
               <fieldset>
                 <button name="save_information"  >Save</button>
               </fieldset>
             </div>
